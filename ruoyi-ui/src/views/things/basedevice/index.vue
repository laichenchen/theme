      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-card>
            ...
            <el-row :span="24">
              <el-table  ref="studentTable" :data="lpBaseDeviceParametersData" style="width: 100%"  :row-class-name="tableRowClassName"
                         @selection-change="clickLogCheckboxHandler"  @current-change="currentChange" highlight-current-row   stripe    border>
